...
$identificador = "SEC@311020191813"
$administradorDominio = "DB.scripts@seniorsolution.com.br"
$arquivoSenha = "\\srsvm030.seniorsolution.com.br\Scripts\SRE\Code\DB\Conf\$identificador.pass"
$chaveCriptografia = Get-Content "\\srsvm030.seniorsolution.com.br\Scripts\SRE\Code\DB\Conf\$identificador.key"
$credencialDominio = New-Object -TypeName System.Management.Automation.PSCredential -ArgumentList $administradorDominio, (Get-Content $arquivoSenha | ConvertTo-SecureString -Key $chaveCriptografia)
